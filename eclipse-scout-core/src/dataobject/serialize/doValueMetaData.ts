 ...
 */
import {BaseDoEntity, Constructor, DoRegistry, ObjectFactory, ObjectType, TypeDescriptor} from '../../index';
...
export const doValueMetaData = {
  ...
  detectDataObjectClass(obj: any): Constructor {
    ...
    if (typeof typeName === 'string') {
      const doConstructor = DoRegistry.get().toConstructor(typeName);
      if (doConstructor) {
