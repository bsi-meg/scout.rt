...
export abstract class Id<TIdValueType, TIdTypeName extends string = string> implements IdModel<TIdValueType, TIdTypeName> {
  ...
  /**
   * Compares this id to the other object. It is considered to be equal if the class, typeName and value are equal.
   * @see objects.equals2
   */
  equals(obj: any) {
    if (this === obj) {
    ...
    return this.typeName === other.typeName
      && objects.equalsRecursive2(this.value, other.value);
  }
