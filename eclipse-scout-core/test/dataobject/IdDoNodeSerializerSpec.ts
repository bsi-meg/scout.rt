...
import {BaseDoEntity, CompositeId, dataObjects, DoRegistry, Id, IdArrayToCompositeIdComponentType, IdParser, idTypeName, NumberId, numbers, ObjectFactory, scout, StringId, typeName, UuId} from '../../src/index';
...
describe('IdDoNodeSerializer', () => {
  ...
  afterAll(() => {
    const doRegistry = DoRegistry.get();
    doRegistry.remove(IdFixture01Do);
  });
