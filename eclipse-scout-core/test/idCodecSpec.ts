...
describe('idCodec', () => {
  ...
  describe('fromUnqualified', () => {
    it('parses correctly', () => {
      ...
      expect(idCodec.fromUnqualified('testId1;testId2;testId3###sig', 'testTypeName')).toEqual({
  ...
  describe('fromQualified', () => {
    it('parses correctly', () => {
      ...
      expect(idCodec.fromQualified('testTypeName:testId1;testId2;testId3###sig')).toEqual({
        typeName: 'testTypeName',
        value: 'testId1;testId2;testId3',
        elements: ['testId1', 'testId2', 'testId3'],
        signature: 'sig'
  ...
  describe('toUnqualified', () => {
    it('works correctly', () => {
      ...
      expect(idCodec.toUnqualified({
        ...
        value: 'testId1;testId2;testId3',
        signature: 'sig'
      })).toBe('testId1;testId2;testId3###sig');
    });
  });
  ...
  describe('toQualified', () => {
    it('works correctly', () => {
      ...
      expect(idCodec.toQualified({
        ...
        value: 'testId1;testId2;testId3',
        signature: 'sig'
      })).toBe('testTypeName:testId1;testId2;testId3###sig');
    });
  });
});
